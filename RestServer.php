<?php
/*
* Made using REST server code got from http://jacwright.com/250/simple-rest-server-in-php-supports-json-amf/
* Have modified some parts to fit to my needs
*/
...
class RestServer
{
	...
	public function handle()
	{
		...
		if ($this->method == 'PUT' || $this->method == 'POST') {
			parse_str($this->getData(), $this->data);
			if($this->getData() == "") { 
				$this->data = $_POST;
			}
		}
